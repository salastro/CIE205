...
public:
	...
	void UpdateStatusBar(int CurrentTimeStep);
	void ResultStatusBar();
	...
	void UpdateInterface(int CurrentTimeStep);
	...
	void PrintCenteredStatusBar(const std::string& msg) const;
